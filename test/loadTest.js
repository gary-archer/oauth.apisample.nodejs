...
export class LoadTest {
     ...
     */
    async sendLoadTestRequests(accessTokens) {
     ...
     */
    createUserInfoRequest(accessToken) {
     ...
     */
    createCompaniesRequest(accessToken) {
        const options = new ApiRequestOptions(accessToken);
        this.initializeApiRequest(options);
     ...
     */
    createTransactionsRequest(accessToken, companyId) {
        const options = new ApiRequestOptions(accessToken);
        this.initializeApiRequest(options);
     ...
     */
    async executeApiRequests(requests) {
        // Set counters
     ...
     */
    outputMessage(colorCode, message) {
