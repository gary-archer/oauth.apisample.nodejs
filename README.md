...
- The API takes finer control over OAuth processing via a certified JOSE library
- The API provides two mechanisms for managing domain specific claims, to enable secure authorization
